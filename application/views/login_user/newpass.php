	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="<?php echo base_url() ?>user/login/updatepass">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Password Baru</span>
						<input class="input100" type="text" id="id_user" name="id_user" placeholder="Enter username" value="<?php echo $id ?>" hidden>
						<input class="input100" type="password" id="password" name="password" placeholder="Enter username">
