										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo base_url().'kasir/barang/add'?>" method="post" enctype="multipart/form-data">
														<div class="row">
															<div class="col-sm-12">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<a href="<?php echo base_url("kasir/barang/hapusBarang/".$key->id_barang) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus">
									...
									<div class="modal fade" id="EditModal<?php echo $id_barang ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo base_url().'kasir/barang/editModal'?>" method="post">
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group ">
																	<!-- <label>ID Barang</label> -->
						...
						<div class="modal fade" id="tambah" role="dialog" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="post" action="<?php echo base_url() ?>kasir/barang/tambahdetail">
											<div class="row">
												<div class="col-sm-12">
													<div class="form-group ">
			...
			<!-- <script type="text/javascript">
		        $(document).ready(function(){
		            $('#bayar').on('keyup',function(){
		                 $.ajax({
		                 	url : <?php echo base_url('kasir/barang/show_keranjang'); ?>
			                var kode = $('#bayar').val();
			                window.alert(kode);
		    ...
		    <script type="text/javascript">
		        $(document).ready(function(){
		            $('#merek').on('change',function(){
		                ...
		                // window.alert(kode);
		                $.ajax({
		                    url  : "<?php echo base_url('kasir/barang/get_merek')?>",
		                    type : "POST",
		                    dataType : "JSON",
		                    data : {merek: kode },
		                    cache:false,
		            ...
		            $('#merekBarang').on('change',function(){
		            	...
		            	$.ajax({
		                    url  : "<?php echo base_url('kasir/barang/get_barang')?>",
		                    type : "POST",
		                    dataType : "JSON",
		    ...
		    <script type="text/javascript">
		    	$(document).ready(function(){
		            $('#merek').on('change',function(){
		                var kode = $('#merek').val();
		                $.ajax({
		                    url  : "<?php echo base_url('kasir/barang/buatkode')?>",
		                    type : "POST",
		                    dataType : "JSON",
		                    data : {merek: kode},
		                    cache:false,
