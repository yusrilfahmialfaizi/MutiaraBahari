							...
							<div class="card">
								...
								<div class="card-body">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url(); ?>kasir/eceran/tambah">
														<div class="row">
															<div class="col-md-12">
									...
									<div class="modal fade" id="update<?php echo $key['rowid']?>" role="dialog" aria-hidden="true">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url() ?>kasir/eceran/updatekeranjang">
									...
									<div class="table-responsive">
										<form method="post" action="<?php echo base_url() ?>kasir/eceran/proses_jual">
											<div class="row">
												<div class="col-md-3">
													<div class="form-group">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					$(document).on('click', '.hapus_cart', function(){
						...
						if (willDelete) {
						$.ajax({
							url		: "<?php echo base_url(); ?>kasir/eceran/hapus_keranjang",
							method 	:"POST",
							data 	: {row_id : row_id},
			...
			<script type="text/javascript">
		        $(document).ready(function(){
		             $('#nama_barang').on('change',function(){
		                ...
		                $.ajax({
		                    type : "POST",
		                    url  : "<?php echo base_url('kasir/eceran/get_barangeceran')?>",
		                    dataType : "JSON",
