										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo base_url().'owner/barang/addmerek'?>" method="post" enctype="multipart/form-data">
														<div class="row">
															<div class="col-sm-12">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<a href="<?php echo base_url("owner/barang/hapusMerek/".$key->id_merek) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus">
									...
									<div class="modal fade" id="EditModal<?php echo $id_merek ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo base_url().'owner/barang/editModalMerek'?>" method="post" enctype="multipart/form-data">
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group  ">
																	<!-- <label>ID Merek</label> -->
