										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Pesanan/<?php echo $konfirmasi->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $p->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $k->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
														</div>
														<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $r->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
														</div>
														<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $t->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
														</div>
														<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $s->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4">
															<a href="<?php echo base_url()?>owner/kasir/pesanan/Detail/<?php echo $key->id_pesanan ?>" class="btn btn-primary btn-round btn-sm  mr-auto">Lihat Barang</a>
														</div>
													</div>
												</div>
											</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(document).on('click', '.menunggu_konfirmasi', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/konfirmasi/",
					data 	:{id_pesanan : id},
			...
			$(document).on('click', '.kemas', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/proses/",
					data 	:{id_pesanan : id},
					success	: function(data){
						swal({
							title: "Selamat!",
			...
			$(document).on('click', '.kirim', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/kemas/",
					data 	:{id_pesanan : id},
					success	: function(data){
						swal({
							title: "Selamat!",
			...
			$(document).on('click', '.diterima', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/kirim/",
					data 	:{id_pesanan : id},
					success	: function(data){
						swal({
							title: "Selamat!",
			...
			$(document).on('click', '.selesai', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/terima/",
					data 	:{id_pesanan : id},
					success	: function(data){
						swal({
							title: "Selamat!",
			...
			$(document).on('click', '.batal', function(){
				...
				$.ajax({
					method 	:"POST",
					url 	:"<?php echo base_url()?>owner/kasir/pesanan/batalkan/",
					data 	:{id_pesanan : id},
					success	: function(data){
						swal({
							title: "Selamat!",
