								...
								<div class="card-header">
									<div class="d-flex align-items-center">
										<div class="form-group">
											<form action="<?php echo base_url() ?>owner/kasir/pesanan">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url('owner/kasir/pesanan/editdetail') ?>" enctype="multipart/form-data">
														<div class="row">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<!-- <a href="<?php echo base_url("owner/kasir/pesanan/hapusdetail/".$key['id_detail_pesan']) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					$('#qty').on('input',function(){
		                ...
		                $.ajax({
		                    type : "POST",
		                    url  : "<?php echo base_url('owner/kasir/pesanan/get_barang')?>",
		                    dataType : "JSON",
					...
					$('#hapus').on('click', function(){
						...
						$.ajax({
							type : "POST",
		                    url  : "<?php echo base_url('owner/kasir/pesanan/hapusdetail')?>",
		                    // dataType : "JSON",
