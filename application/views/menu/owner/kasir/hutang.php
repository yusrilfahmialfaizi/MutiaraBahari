										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url('owner/kasir/hutang/tambahHutang') ?>"enctype="multipart/form-data">
														<div class="row">
															<!-- <div class="col-sm-12">
									...
									<div class="modal fade" id="ModalEdit<?php echo $y->id_hutang ?>" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url() ?>owner/kasir/hutang/updateHutang" enctype="multipart/form-data">
														<div class="row">
															<div class="col-md-6 pr-0">
																<div class="form-group">
																	<label for="largeInput">ID Hutang</label>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<!-- <a href="<?php //echo site_url("owner/kasir/grosir/hapusHutang/".$k->id_hutang) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus">
			...
			<script type="text/javascript">
		        $(document).ready(function(){
		             $('#nama_pelanggan').on('change',function(){
		                ...
		                $.ajax({
		                    type : "POST",
		                    url  : "<?php echo base_url('owner/kasir/hutang/get_id')?>",
		                    dataType : "JSON",
		                    data : {nama: nama },
		                    cache:false,
