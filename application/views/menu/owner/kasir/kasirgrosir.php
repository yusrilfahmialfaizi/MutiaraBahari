							...
							<div class="card">
								...
								<div class="card-body">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="<?php echo base_url(); ?>owner/kasir/grosir/keranjang_kasir">
														<div class="row">
															<div class="col-md-12">
									...
									<div class="modal fade" id="update<?php echo $key['rowid']?>" role="dialog" aria-hidden="true">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<!--action="<?php //echo base_url(); ?>owner/kasir/grosir/keranjang_kasir"-->
												<div class="modal-body">
													<form method="post" action="<?php echo base_url() ?>owner/kasir/grosir/updatekeranjang">
									...
									<div class="table-responsive">
										<form action="<?php echo base_url('owner/kasir/grosir/proses_jual') ?>" method="post">
											<div class="row">
												<div class="col-md-3">
													<div class="form-group">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					$(document).on('click', '.hapus_cart', function(){
						...
						if (willDelete) {
						$.ajax({
							url		: "<?php echo base_url(); ?>owner/kasir/grosir/hapus_keranjang",
							method 	:"POST",
							data 	: {row_id : row_id},
			...
			<script type="text/javascript">
		        $(document).ready(function(){
		             $('#nama_barang').on('change',function(){
		                ...
		                $.ajax({
		                    type : "POST",
		                    url  : "<?php echo base_url('owner/kasir/grosir/get_barang')?>",
		                    dataType : "JSON",
		    ...
		    <script type="text/javascript">
		    	$(document).ready(function(){
		    		$('#qty').on('input', function(){
		 				...
		 				$.ajax({
		 					type : "POST",
		 					url : "<?php echo base_url('owner/kasir/grosir/get_harga')?>",
