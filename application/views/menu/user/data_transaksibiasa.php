													...
													<div class="row">
														<div class="col-md-4 ml-auto mr-auto">
															<div class="form-group">
																<a href="<?php echo base_url()?>user/pelanggan/pemesanan/detail_pesanan/<?php echo $key->id_pesanan ?>" class="btn btn-primary btn-round btn-md">Lihat Barang</a>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<div class="col-md-4 ml-auto mr-auto">
															<div class="form-group">
																<a href="<?php echo base_url()?>user/pelanggan/pemesanan/detail_pesanan/<?php echo $key->id_pesanan ?>" class="btn btn-danger btn-round btn-md">Lihat Barang</a>
															</div>
														</div>
													</div>
												</div>
