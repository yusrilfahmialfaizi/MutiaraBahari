			...
			<div class="content">
				<div class="page-inner">
							...
							<div class="card card-stats card-round">
								...
								<div class="card-footer">
									<div class="col-md-6 ml-auto mr-auto">
										<a href="<?php echo base_url("user/pelanggan/dashboard/produk/".$key->merek) ?>" class="btn btn-primary btn-border btn-round btn-md">Lihat</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<form method="post" action="<?php echo base_url() ?>user/pelanggan/pemesanan/tambahkeranjang" >
							<div class="card card-stats card-round">
								<div class="card-body ">
									<div class="row">
										<div class="col-md-6">
										...
										<div class="col-md-6 col-stats">
											<div class="numbers">
												<div class="form-group">
													...
													<h5 style="text-align : center"><strong><?php echo 'Rp '.number_format($key->harga);?></strong></h5>
													<h7 style="text-align : center"><strong> Sisa : <?php echo $key->jumlah_stok?></strong></h7>
													<input type="text" name="harga" id="harga" value="<?php echo 'Rp '.number_format($key->harga);?>" class="qty form-control" readonly hidden>
