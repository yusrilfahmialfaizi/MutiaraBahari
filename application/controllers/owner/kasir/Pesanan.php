<?php
	...
	class Pesanan extends CI_Controller
	{
		...
		function index()
		{
			...
			$this->load->view('menu/owner/kasir/pesanan', $data);
		}
		function Pesanan($no_pesanan)
		{
			...
			$this->load->view('_partial/headerowner');
			$this->load->view('menu/owner/kasir/detail_pesanan', $data);
		}
		function Detail($no_pesanan)
		{
			...
			$data['detail_pesanan'] = $this->Pesananmodel->getDetail($no_pesanan);
			$this->load->view('_partial/headerowner');
			$this->load->view('menu/owner/kasir/data_pesanan', $data);
		}
		function editdetail()
		{
			...
			redirect("owner/kasir/pesanan/Pesanan/$id_pesanan");
		}
		function get_barang()
		{
